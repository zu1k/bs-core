//! Ascii Folding
//! This is copied from https://github.com/quickwit-oss/tantivy/blob/main/src/tokenizer/ascii_folding_filter.rs

pub(crate) fn to_ascii(text: &mut String) {
